//fetch id of all elements used in alarm clock
...
// Adding Hours, Minutes, Seconds in DropDown Menu whenever page refresh
...
// setting time every second with current time
...
function getCurrentTime() {
  ...
  //rendering current time to html view
  currentTime.innerHTML = time;
  return time;
}

// function will take input from user to set alarm time
function getInput(e) {
  e.preventDefault();
...
// create div and add alarm to local storage and render view of saved alarms
